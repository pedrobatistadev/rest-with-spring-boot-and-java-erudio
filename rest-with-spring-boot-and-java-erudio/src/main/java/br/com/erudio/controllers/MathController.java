...
public class MathController {
    ...
    public Double subtr(@PathVariable("number1") String number1, @PathVariable("number2") String number2) {

        if (!mathValidation.isNumber(number1) || !mathValidation.isNumber(number2)) {
            throw new UnsupportedMathOperationException("Insira um valor válido ! ");
        }

        return math.subtr(mathValidation.convertDouble(number1), mathValidation.convertDouble(number2));
    }
    ...
    public Double div(@PathVariable("number1") String number1, @PathVariable("number2") String number2) {
        ...
        return math.div(mathValidation.convertDouble(number1), mathValidation.convertDouble(number2));
    }
